...
export default function BrowseClient({
  ...
  // The server prefetched exactly the default view. The moment the visitor
  // searches, filters, or re-sorts, the query key changes and React Query goes
  // to the network — so we must not hand it stale seed data for those.
  const isDefaultView = !query && !category && sort === DEFAULT_SORT;
